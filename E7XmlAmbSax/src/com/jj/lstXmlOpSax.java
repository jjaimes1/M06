...
public class lstXmlOpSax extends DefaultHandler{
	...
	public static void main(String[] args) throws FileNotFoundException, IOException, SAXException {
		...
		InputSource fileXML = new InputSource("produkte.xml");
		...
		//########
			...
			if (isNumeric(op)) {
				...
				}else {System.out.println("selecione un numero de la lista porfavor.");}
